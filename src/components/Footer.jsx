...
<footer className="bg-white dark:bg-gray-900">
    ...
    <div className="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span className="text-sm ml-10 text-gray-500 dark:text-gray-300 sm:text-center">© 2024 <a href="https://flowbite.com/">Venus Computers</a>. All Rights Reserved.
        </span>
        <div className="flex mr-44 mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
